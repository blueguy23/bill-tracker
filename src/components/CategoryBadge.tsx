...
const STYLES: Record<BillCategory, { pill: string; dot: string }> = {
  ...
  loans:         { pill: 'bg-red-500/10 text-red-400 border-red-500/20',       dot: 'bg-red-500' },
  other:         { pill: 'bg-zinc-800 text-zinc-400 border-zinc-700',        dot: 'bg-zinc-500' },
};
...
export function CategoryBadge({ category }: CategoryBadgeProps) {
  ...
  return (
    <Badge variant="outline" className={`gap-1.5 capitalize ${s.pill}`}>
